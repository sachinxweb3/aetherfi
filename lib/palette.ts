...
export const PALETTE_ACTIONS: PaletteAction[] = [
  ...
  { id: "nav-swap", label: "Swap", hint: "Exchange assets on Arc", href: "/swap", kind: "navigate", keywords: ["swap", "exchange", "trade", "convert"] },
  { id: "nav-bridge", label: "Bridge", hint: "Move assets across networks", href: "/bridge", kind: "navigate", keywords: ["bridge", "cross-chain", "network", "transfer", "move"] },
  { id: "nav-oracle", label: "Oracle", hint: "Live price feeds", href: "/oracle", kind: "navigate", keywords: ["oracle", "price", "prices", "feed", "feeds", "market"] },
  ...
  { id: "nav-compare", label: "Compare", hint: "Two wallets side by side", href: "/compare", kind: "navigate", keywords: ["compare", "versus", "vs", "battle", "wallets", "against"] },
